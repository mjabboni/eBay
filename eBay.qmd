...
e. Change variable types for (Currency, endDay, Category, and Competitive) from objects to
category for modeling
Hint: ebay_df['currency'] = ebay_df['currency'].astype('category')
f. Create dummy variables for these categories and drop the first reference
Hint Code:
