...
sns.heatmap(cm, annot=True, fmt='d', cmap='Blues', ax=axes[0],
            xticklabels=['Non-Comp (0)', 'Comp (1)'],
            yticklabels=['Non-Comp (0)', 'Comp (1)'],
            annot_kws={'size': 16})
axes[0].set_xlabel('Predicted', fontsize=12)
axes[0].set_ylabel('Actual', fontsize=12)
axes[0].set_title(f'With ClosePrice\nAccuracy: {accuracy:.2%}', fontsize=13)

# Without ClosePrice
sns.heatmap(cm_nc, annot=True, fmt='d', cmap='Oranges', ax=axes[1],
            xticklabels=['Non-Comp (0)', 'Comp (1)'],
            yticklabels=['Non-Comp (0)', 'Comp (1)'],
            annot_kws={'size': 16})
axes[1].set_xlabel('Predicted', fontsize=12)
axes[1].set_ylabel('Actual', fontsize=12)
axes[1].set_title(f'Without ClosePrice\nAccuracy: {accuracy_nc:.2%}', fontsize=13)
