...
```{python}
# Violin plot: Distribution of OpenPrice by Competitive Status
plt.figure(figsize=(10, 6))
ebay_df['Competitive_Label'] = ebay_df['Competitive'].map({0: 'Non-Competitive', 1: 'Competitive'})
sns.violinplot(x='Competitive_Label', y='OpenPrice', data=ebay_df, 
               palette=['#E74C3C', '#27AE60'], inner='box')
plt.xlabel('Auction Type', fontsize=12)
plt.ylabel('Opening Price ($)', fontsize=12)
plt.title('Distribution of Opening Price: Competitive vs Non-Competitive Auctions', fontsize=14)
plt.tight_layout()
plt.show()
```
...
## Part g: Data Partitioning (60% Train / 40% Test)
